...
const CASES = [
  {
    ...
    config: {
      ...
      referenceNotes: "未上传真实写法参考时，大创项目书采用 challenge-cup-project-book skill 的竞赛项目书结构：项目方案概述、项目团队概述、研究目标与内容、研究方法与技术路线、创新点与项目特色、应用场景与需求验证、预期成果与实施计划、风险控制与质量评价、经费预算与用途、证明材料与附件清单和后续验证安排。",
  ...
  },
  {
    ...
    config: {
      ...
      contestFileNotes: "本项目使用 challenge-cup-project-book skill 结构，不套用养老防摔、RAG养老智能体或旧商业计划书稿。",
  ...
  },
  {
    ...
    config: {
      ...
      referenceNotes: "未上传真实写法参考时，使用 challenge-cup-project-book skill 的竞赛项目书结构，不借用历史商业计划书标题体系。",
      contestFileNotes: "本项目不复用养老防摔、非接触中间件或白板协作项目内容。",
  ...
  },
  {
    ...
    config: {
      ...
      referenceNotes: "未上传真实写法参考时，大创项目书采用 challenge-cup-project-book skill 的竞赛项目书结构，不复用其他项目文章内容。",
